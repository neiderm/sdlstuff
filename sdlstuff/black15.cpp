...
//memset(z_bank_2, bank_size);
    ...
    _asm
    {
        ...
        les di,z_bank_1       ;
        point es:di to z buffer bank 1
        mov ax,value          ;
        move the value into ax
        mov cx,z_bank_size    ;
        number of bytes to fill
        shr cx,1              ;
        convert to number of words
        rep stosw             ;
        move the value into z buffer
        ...
        point es:di to z buffer bank 1
        mov ax,value          ;
        move the value into ax (redundant)
        mov cx,z_bank_size    ;
        number of bytes to fill  (so is this)
        shr cx,1              ;
        convert to number of words
        rep stosw             ;
        move the value into z buffer
...
// SECTION 3  ////////////////////////////////////////////////////////////////
        ...
        else if (POINTS_EQUAL_3D(root->wall_world[0],next_wall->wall_world[1]) )
        {
        ...
        else if (POINTS_EQUAL_3D(root->wall_world[1],next_wall->wall_world[0]) )
        {
        ...
        else if (POINTS_EQUAL_3D(root->wall_world[1],next_wall->wall_world[1]) )
        {
...
// SECTION  5 ////////////////////////////////////////////////////////////////
        else if ( (dot_wall_1 < 0 && dot_wall_2 < 0) || back_flag)
        {
